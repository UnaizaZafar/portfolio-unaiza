...
const HeroSection = () => {
    ...
    return (
        <section id="hero" className="bg-secondary h-screen flex flex-col gap-6 items-center justify-center">
            <h1
                ref={wordsRef}
                className="font-gamilia text-[160px] font-medium leading-32 text-center text-primary max-w-3/5 "
            >

    ...
    return (
        <div id="about"
            ...
            <div className="flex flex-col max-w-screen-lg mx-auto rounded-3xl border-3 border-purple-900/80 overflow-hidden">
                <div className="flex gap-2.5 px-6 py-3 bg-purple-900/80">
                ...
                <div className="flex flex-col gap-5 bg-gradient-to-b from-purple-950/70 via-purple-950 to-purple-900/85 shadow-inner px-6 py-10">
